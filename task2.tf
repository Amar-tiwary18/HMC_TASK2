 ...
 depends_on = [ 
  ...
  provisioner "remote-exec" {
      inline = [
        ...
        "sudo curl https://raw.githubusercontent.com/Amar-tiwary18/HMC_TASK2/master/index.html > index.html",                                  "sudo cp index.html  /var/www/html/",
      ]
  }
}
...
resource "aws_s3_bucket_object" "task-2-object" {
  ...
  key    = "one"
  source = "C:/Users/Admin/Desktop/terra/repo/terraform.jpg"
  etag = "C:/Users/Admin/Desktop/terra/repo/terraform.jpg"
  acl = "public-read"
